...
!    do_wave_emit(nlwbands+1:) = .FALSE.
    ...
    do ielem = 1, NELEM
      ...
      print*,'FVDBG.carma_register shortname, ielem, igroup : '//trim(shortname), ielem, igroup
      print*,'FVDBG.carma_register name, ielem, igroup : '//trim(name), ielem, igroup
      ...
      if (cnsttype == I_CNSTTYPE_PROGNOSTIC) then
        ...
        do ibin = 1, NBIN
          ...
          if (ibin <= maxbin) then
            ...
            print*,'FVDBG.carma_register  cnst_add: '//trim(c_name), ielem, ibin, icnst4elem(ielem, ibin)

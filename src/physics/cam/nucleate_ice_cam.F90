      ...
      do n = 1, nspec
         ...
         if (trim(str32)=='dust') then
            if (coarse_dust_idx>0) then
               call endrun('nucleate_ice_cam_init: more then one coarse dust species found')
            end if
            coarse_dust_idx = n
         end if
      end do
      ...
      do n = 1, nspec
         ...
         if (trim(str32)=='seasalt') then
            if (coarse_nacl_idx>0) then
               call endrun('nucleate_ice_cam_init: more then one coarse seasalt species found')
            end if
            coarse_nacl_idx = n
         end if
      end do
         ...
         do n = 1, nspec
            ...
            if (trim(str32)=='sulfate') then
               if (coarse_so4_idx>0) then
                  call endrun('nucleate_ice_cam_init: more then one coarse sulfate species found')
               end if
               coarse_so4_idx = n
            end if
         end do

...
subroutine microp_aero_run ( &
   ...
   if (clim_modal_aero) then
      ...
      pres(:ncol,:pver)=rair*rho(:ncol,:pver)*state1%t(:ncol,:pver)
      call qsat(state1%t(:ncol,:pver), pres(:ncol,:pver), sat_vpress(:ncol,:pver), sat_spchum(:ncol,:pver), ncol, pver)

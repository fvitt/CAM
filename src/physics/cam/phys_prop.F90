...
!st added paramteters..for Penfei's CARMA model
...
! Added by Pengfei Yu to get coreshell optical properties
...
!st
   case ('hygroscopic_wtp')                     ! + Pengfei Yu
      call hygroscopic_wtp_optics_init(phys_prop, nc_id)

   case ('hygroscopic_coreshell')               ! + Pengfei Yu

...
!-------------------------------------------------------
      ...
      rate(:,:,577) = 8e-10_r8 * exp_fac(:,:)
      rate(:,:,578) = 5e-12_r8 * exp_fac(:,:)
      rate(:,:,579) = 7e-10_r8 * exp_fac(:,:)
      rate(:,:,582) = 4.8e-10_r8 * exp_fac(:,:)
      rate(:,:,583) = 1e-10_r8 * exp_fac(:,:)
      rate(:,:,584) = 4e-10_r8 * exp_fac(:,:)
...
!-------------------------------------------------------
      ...
      rate(:,:kbot,577) = 8e-10_r8
      rate(:,:kbot,578) = 5e-12_r8
      rate(:,:kbot,579) = 7e-10_r8
      rate(:,:kbot,582) = 4.8e-10_r8
      rate(:,:kbot,583) = 1e-10_r8
      rate(:,:kbot,584) = 4e-10_r8

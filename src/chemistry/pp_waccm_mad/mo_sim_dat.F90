...
!--------------------------------------------------------------
      ...
      permute(: 88,4) = (/    6,  52,  18,  56,  39,  12,   4,   1,  81,  35, &
                             27,   2,   5,  71,  31,  86,  50,  19,  32,  72, &
                              7,  73,  61,  14,  30,  33,  26,  40,  38,  69, &
                             87,  79,  74,  85,  75,   3,  44,  78,  58,  46, &
                             45,  36,  64,  43,  54,  59,  68,  11,  42,  22, &
                             65,   8,  80,   9,  82,  28,  17,  23,  62,  47, &
                             60,  53,  55,  48,  51,  66,  67,  13,  25,  70, &
                             24,  20,  57,  37,  10,  76,  77,  29,  49,  21, &
                             41,  63,  83,  84,  34,  16,  15,  88 /)

      diag_map(: 88) = (/    1,   4,   7,  10,  12,  16,  19,  22,  26,  30, &
                            33,  39,  45,  51,  58,  65,  71,  76,  84,  91, &
                            98, 105, 112, 122, 130, 137, 142, 148, 156, 165, &
                           174, 182, 191, 199, 211, 221, 229, 239, 252, 265, &
                           279, 291, 305, 322, 334, 350, 365, 379, 395, 413, &
                           432, 451, 471, 491, 513, 535, 567, 591, 613, 646, &
                           680, 706, 749, 779, 823, 870, 914, 958,1001,1044, &
                          1086,1132,1173,1230,1269,1306,1352,1396,1432,1476, &
                          1520,1564,1598,1635,1679,1716,1762,1816 /)
      ...
      rxt_tag_lst(   201:   400) = (/ 'iira52                          ', 'iira53                          ', &
                                      ...
                                      'O2_1S_O3                        ', 'O_O3                            ', &
                                      'usr_O_O                         ', 'usr_O_O2                        ' /)
      rxt_tag_lst(   401:   584) = (/ 'H2_O                            ', 'H2O2_O                          ', &
                                      'H_HO2                           ', 'H_HO2a                          ', &
                                      'H_HO2b                          ', 'H_O2                            ', &
                                      'HO2_O                           ', 'HO2_O3                          ', &
                                      'H_O3                            ', 'OH_H2                           ', &
      ...
      cph_enthalpy(:) = (/   189.810000_r8,   32.910000_r8,  189.810000_r8,   94.300000_r8,   94.300000_r8, &
                             ...
                             406.160000_r8,  271.380000_r8,  105.040000_r8,  150.110000_r8,  319.370000_r8, &
                             128.320000_r8,  319.360000_r8,  469.400000_r8,  163.060000_r8,  482.430000_r8, &
                             291.380000_r8,   67.540000_r8,  501.720000_r8 /)

...
!-------------------------------------------------------
      ...
      rate(:n,113) = 1e-20_r8
      rate(:n,114) = 1.3e-16_r8
      rate(:n,118) = 8e-14_r8
      rate(:n,119) = 3.9e-17_r8
      rate(:n,126) = 6.9e-12_r8
      rate(:n,142) = 7e-13_r8
      rate(:n,143) = 5e-12_r8
      rate(:n,297) = 0.047_r8
      rate(:n,298) = 7.7e-05_r8
      rate(:n,299) = 0.171_r8
      rate(:n,303) = 6e-11_r8
      rate(:n,306) = 1e-12_r8
      rate(:n,307) = 4e-10_r8
      rate(:n,308) = 2e-10_r8
      rate(:n,309) = 1e-10_r8
      rate(:n,311) = 4.4e-10_r8
      rate(:n,314) = 1.3e-10_r8
      rate(:n,317) = 8e-10_r8
      rate(:n,318) = 5e-12_r8
      rate(:n,319) = 7e-10_r8
      rate(:n,322) = 4.8e-10_r8
      rate(:n,323) = 1e-10_r8
      rate(:n,324) = 4e-10_r8
      ...
      rate(:n,109) = 2.15e-11_r8 * exp( 110._r8 * itemp(:) )
      exp_fac(:) = exp( 55._r8 * itemp(:) )
      rate(:n,110) = 2.64e-11_r8 * exp_fac(:)
      rate(:n,111) = 6.6e-12_r8 * exp_fac(:)
      rate(:n,115) = 3.6e-18_r8 * exp( -220._r8 * itemp(:) )
      rate(:n,117) = 1.8e-15_r8 * exp( 45._r8 * itemp(:) )
      rate(:n,120) = 3.5e-11_r8 * exp( -135._r8 * itemp(:) )
      rate(:n,121) = 8e-12_r8 * exp( -2060._r8 * itemp(:) )
      rate(:n,130) = 3e-11_r8 * exp( 200._r8 * itemp(:) )
      rate(:n,131) = 1e-14_r8 * exp( -490._r8 * itemp(:) )
      rate(:n,132) = 1.4e-10_r8 * exp( -470._r8 * itemp(:) )
      rate(:n,135) = 4.8e-11_r8 * exp( 250._r8 * itemp(:) )
      rate(:n,136) = 1.8e-11_r8 * exp( 180._r8 * itemp(:) )
      rate(:n,137) = 1.7e-12_r8 * exp( -940._r8 * itemp(:) )
      rate(:n,144) = 2.1e-11_r8 * exp( 100._r8 * itemp(:) )
      rate(:n,148) = 3.3e-12_r8 * exp( -3150._r8 * itemp(:) )
      rate(:n,149) = 5.1e-12_r8 * exp( 210._r8 * itemp(:) )
      rate(:n,157) = 3.44e-12_r8 * exp( 260._r8 * itemp(:) )
      rate(:n,158) = 3e-12_r8 * exp( -1500._r8 * itemp(:) )

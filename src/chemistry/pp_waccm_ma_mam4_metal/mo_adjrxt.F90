...
!--------------------------------------------------------------------
      ...
      rate(:,:, 317) = rate(:,:, 317) * inv(:,:, 2)
      rate(:,:, 322) = rate(:,:, 322) * inv(:,:, 2)
      rate(:,:, 323) = rate(:,:, 323) * inv(:,:, 2)
      rate(:,:, 331) = rate(:,:, 331) * inv(:,:, 1)
      rate(:,:, 333) = rate(:,:, 333) * inv(:,:, 1)
      rate(:,:, 339) = rate(:,:, 339) * inv(:,:, 1)
      rate(:,:, 344) = rate(:,:, 344) * inv(:,:, 2)
      ...
      rate(:,:, 402) = rate(:,:, 402) * inv(:,:, 1)
      rate(:,:, 403) = rate(:,:, 403) * inv(:,:, 1)
      ...
      rate(:,:, 502) = rate(:,:, 502) * inv(:,:, 2)
      rate(:,:, 504) = rate(:,:, 504) * inv(:,:, 2)
      rate(:,:, 510) = rate(:,:, 510) * inv(:,:, 2)
      rate(:,:, 338) = rate(:,:, 338) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 370) = rate(:,:, 370) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 396) = rate(:,:, 396) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 477) = rate(:,:, 477) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 493) = rate(:,:, 493) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 107) = rate(:,:, 107) * m(:,:)
      rate(:,:, 108) = rate(:,:, 108) * m(:,:)
      rate(:,:, 110) = rate(:,:, 110) * m(:,:)
      rate(:,:, 111) = rate(:,:, 111) * m(:,:)

...
!-------------------------------------------------------
      ...
      call jpl( rate(1,1,410), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 6.9e-31_r8 * itemp(:,:)**1._r8
      kinf(:,:) = 2.6e-11_r8
      call jpl( rate(1,1,420), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 2.5e-31_r8 * itemp(:,:)**1.8_r8
      kinf(:,:) = 2.2e-11_r8 * itemp(:,:)**0.7_r8
      call jpl( rate(1,1,432), m, 0.6_r8, ko, kinf, n )
      ...
      call jpl( rate(1,1,443), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 2.4e-30_r8 * itemp(:,:)**3._r8
      kinf(:,:) = 1.6e-12_r8 * itemp(:,:)**(-0.1_r8)
      call jpl( rate(1,1,444), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 1.8e-30_r8 * itemp(:,:)**3._r8
      kinf(:,:) = 2.8e-11_r8
      call jpl( rate(1,1,445), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 1.8e-31_r8 * itemp(:,:)**3.4_r8
      kinf(:,:) = 1.5e-11_r8 * itemp(:,:)**1.9_r8
      call jpl( rate(1,1,463), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 1.9e-32_r8 * itemp(:,:)**3.6_r8
      kinf(:,:) = 3.7e-12_r8 * itemp(:,:)**1.6_r8
      call jpl( rate(1,1,483), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 5.2e-31_r8 * itemp(:,:)**3.2_r8
      kinf(:,:) = 6.9e-12_r8 * itemp(:,:)**2.9_r8
      call jpl( rate(1,1,494), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 5.9e-33_r8 * itemp(:,:)**1._r8
      kinf(:,:) = 1.1e-12_r8 * itemp(:,:)**(-1.3_r8)
      call jpl( rate(1,1,536), m, 0.6_r8, ko, kinf, n )
...
!-------------------------------------------------------
      ...
      rate(:,:kbot,394) = 1e-20_r8
      rate(:,:kbot,395) = 1.3e-16_r8
      rate(:,:kbot,399) = 8e-14_r8
      rate(:,:kbot,400) = 3.9e-17_r8
      rate(:,:kbot,407) = 6.9e-12_r8
      rate(:,:kbot,423) = 7e-13_r8
      rate(:,:kbot,424) = 5e-12_r8
      rate(:,:kbot,582) = 6e-11_r8
      rate(:,:kbot,585) = 1e-12_r8
      rate(:,:kbot,586) = 4e-10_r8
      rate(:,:kbot,587) = 2e-10_r8
      rate(:,:kbot,588) = 1e-10_r8
      rate(:,:kbot,590) = 4.4e-10_r8
      itemp(:ncol,:kbot) = 1._r8 / temp(:ncol,:kbot)
      n = ncol*kbot
      rate(:,:kbot,390) = 2.15e-11_r8 * exp( 110._r8 * itemp(:,:) )
      exp_fac(:,:) = exp( 55._r8 * itemp(:,:) )
      rate(:,:kbot,391) = 2.64e-11_r8 * exp_fac(:,:)
      rate(:,:kbot,392) = 6.6e-12_r8 * exp_fac(:,:)
      rate(:,:kbot,396) = 3.6e-18_r8 * exp( -220._r8 * itemp(:,:) )
      rate(:,:kbot,398) = 1.8e-15_r8 * exp( 45._r8 * itemp(:,:) )
      rate(:,:kbot,401) = 3.5e-11_r8 * exp( -135._r8 * itemp(:,:) )
      rate(:,:kbot,402) = 8e-12_r8 * exp( -2060._r8 * itemp(:,:) )
      rate(:,:kbot,411) = 3e-11_r8 * exp( 200._r8 * itemp(:,:) )
      rate(:,:kbot,412) = 1e-14_r8 * exp( -490._r8 * itemp(:,:) )
      rate(:,:kbot,413) = 1.4e-10_r8 * exp( -470._r8 * itemp(:,:) )
      rate(:,:kbot,416) = 4.8e-11_r8 * exp( 250._r8 * itemp(:,:) )
      rate(:,:kbot,417) = 1.8e-11_r8 * exp( 180._r8 * itemp(:,:) )
      rate(:,:kbot,418) = 1.7e-12_r8 * exp( -940._r8 * itemp(:,:) )
      rate(:,:kbot,425) = 2.1e-11_r8 * exp( 100._r8 * itemp(:,:) )
      rate(:,:kbot,429) = 1.5e-11_r8 * exp( -3600._r8 * itemp(:,:) )
      rate(:,:kbot,430) = 5.1e-12_r8 * exp( 210._r8 * itemp(:,:) )
      rate(:,:kbot,438) = 3.3e-12_r8 * exp( 270._r8 * itemp(:,:) )
      rate(:,:kbot,439) = 3e-12_r8 * exp( -1500._r8 * itemp(:,:) )

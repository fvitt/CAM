...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 123, & ! number of photolysis reactions
                            rxntot = 528, & ! number of total reactions
                            gascnt = 405, & ! number of gas phase reactions
                            ...
                            nzcnt = 2038, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 206, & ! number of species in implicit class

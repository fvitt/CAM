...
!--------------------------------------------------------------------
      if( class == 1 ) then
         ...
         prod(:,15) = 0._r8
         prod(:,16) = 0._r8
         prod(:,17) = (rxt(:,237)*y(:,70) +rxt(:,241)*y(:,70))*y(:,29)
         prod(:,18) = 0._r8
         prod(:,19) = 0._r8
         prod(:,20) = 0._r8
         prod(:,21) = 0._r8
         prod(:,22) = 0._r8
         prod(:,23) =rxt(:,127)*y(:,53)*y(:,49)
         prod(:,24) = 0._r8
!--------------------------------------------------------------------
...
!--------------------------------------------------------------------
         ...
         prod(:,48) =4.000_r8*rxt(:,30)*y(:,6) +rxt(:,31)*y(:,7) +2.000_r8*rxt(:,33) &
                 ...
                 *y(:,17) +rxt(:,41)*y(:,18) +rxt(:,52)*y(:,40) +rxt(:,53)*y(:,41) &
                  +rxt(:,54)*y(:,42)
         prod(:,6) = 0._r8
         prod(:,1) = 0._r8
         prod(:,43) = 0._r8
         ...
         prod(:,2) =rxt(:,31)*y(:,7) +rxt(:,32)*y(:,8) +rxt(:,34)*y(:,10) &
                 ...
                 *y(:,13) +2.000_r8*rxt(:,50)*y(:,37) +rxt(:,53)*y(:,41) +rxt(:,54) &
                 *y(:,42)
         prod(:,7) =rxt(:,33)*y(:,9) +rxt(:,34)*y(:,10) +rxt(:,52)*y(:,40)

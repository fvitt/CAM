...
!----------------------------------------------
      ...
      do k = 1,avec_len
         ...
         mat(k,433) = rxt(k,176)*y(k,7) + rxt(k,202)*y(k,8) + 3.000_r8*rxt(k,203)*y(k,22) &
                      + 2.000_r8*rxt(k,204)*y(k,37) + 2.000_r8*rxt(k,225)*y(k,14) &
                      + rxt(k,226)*y(k,16)
         ...
         mat(k,443) = 4.000_r8*rxt(k,175)*y(k,6) + rxt(k,176)*y(k,7) &
                      ...
                      + 2.000_r8*rxt(k,181)*y(k,13) + rxt(k,227)*y(k,40) &
                      + rxt(k,228)*y(k,41) + rxt(k,229)*y(k,42)
         ...
         mat(k,421) = rxt(k,176)*y(k,7) + rxt(k,178)*y(k,10) + 2.000_r8*rxt(k,179)*y(k,11) &
                      ...
                      + rxt(k,202)*y(k,8) + 2.000_r8*rxt(k,204)*y(k,37) &
                      + rxt(k,228)*y(k,41) + rxt(k,229)*y(k,42)
         mat(k,516) = rxt(k,223)*y(k,41) + rxt(k,224)*y(k,42)
         mat(k,17) = -( rxt(k,49) + het_rates(k,32) )
         mat(k,423) = rxt(k,177)*y(k,9) + rxt(k,178)*y(k,10) + rxt(k,227)*y(k,40)
         mat(k,517) = rxt(k,222)*y(k,40)
         ...
         mat(k,362) = -( het_rates(k,36) )
         mat(k,250) = rxt(k,1)
         mat(k,286) = rxt(k,21)
         mat(k,434) = rxt(k,240)*y(k,21)
         mat(k,71) = -( rxt(k,4) + het_rates(k,38) )
         mat(k,311) = .500_r8*rxt(k,242)
         mat(k,110) = -( rxt(k,51) + het_rates(k,39) )
         mat(k,264) = -( rxt(k,55) + het_rates(k,43) )
         mat(k,574) = rxt(k,151)*y(k,21) + rxt(k,213)*y(k,14) + rxt(k,215)*y(k,16) &
                      + 2.000_r8*rxt(k,218)*y(k,18) + rxt(k,220)*y(k,22)
         mat(k,24) = -( rxt(k,56) + het_rates(k,44) )
         mat(k,101) = rxt(k,207)*y(k,21)
         mat(k,216) = -( rxt(k,9) + het_rates(k,45) )
         ...
         mat(k,39) = -( rxt(k,10) + rxt(k,11) + rxt(k,148) + het_rates(k,46) )
         mat(k,93) = -( rxt(k,57) + het_rates(k,47) )
         mat(k,60) = rxt(k,248) + rxt(k,251) + rxt(k,256)
         mat(k,119) = -( rxt(k,58) + het_rates(k,48) )
         mat(k,203) = rxt(k,250) + rxt(k,255) + rxt(k,261)
         mat(k,193) = -( rxt(k,62) + het_rates(k,49) )
         mat(k,378) = rxt(k,15)
         mat(k,142) = rxt(k,279)
         mat(k,27) = -( rxt(k,13) + rxt(k,14) + rxt(k,149) + rxt(k,243) + rxt(k,246) &
                      + rxt(k,249) + rxt(k,260) + het_rates(k,51) )
         mat(k,385) = -( rxt(k,15) + rxt(k,16) + het_rates(k,52) )
         mat(k,29) = rxt(k,14)
         mat(k,410) = rxt(k,17) + .500_r8*rxt(k,244)
         mat(k,505) = rxt(k,19)
         mat(k,154) = rxt(k,276)
         mat(k,51) = rxt(k,289)
         mat(k,435) = 2.000_r8*rxt(k,142)*y(k,50)
         mat(k,411) = -( rxt(k,17) + rxt(k,244) + het_rates(k,53) )
         mat(k,220) = rxt(k,9)
         ...
         mat(k,236) = -( rxt(k,5) + rxt(k,6) + rxt(k,77) + rxt(k,78) + rxt(k,79) &
                      ...
                      + rxt(k,85) + rxt(k,86) + het_rates(k,56) )
         mat(k,593) = rxt(k,8)
         mat(k,498) = rxt(k,19)
         mat(k,11) = rxt(k,87) + rxt(k,95)
         mat(k,14) = rxt(k,88)
         mat(k,427) = rxt(k,143)*y(k,50)
         mat(k,607) = -( rxt(k,7) + rxt(k,8) + het_rates(k,57) )
         mat(k,7) = -( rxt(k,59) + het_rates(k,58) )
         ...
         mat(k,320) = -( rxt(k,242) + het_rates(k,61) )
         ...
         mat(k,178) = -( het_rates(k,62) )
         mat(k,78) = -( het_rates(k,63) )
         mat(k,54) = rxt(k,283)
         mat(k,48) = rxt(k,288)
         mat(k,87) = -( het_rates(k,64) )
         mat(k,374) = rxt(k,16)
         mat(k,148) = rxt(k,276)
         mat(k,136) = rxt(k,279)
         mat(k,127) = -( het_rates(k,65) )
         mat(k,188) = rxt(k,62)
         mat(k,49) = rxt(k,289)
         mat(k,437) = -( rxt(k,91) + rxt(k,142)*y(k,50) + rxt(k,143)*y(k,50) &
                      ...
                      + rxt(k,204)*y(k,37) + rxt(k,225)*y(k,14) + rxt(k,226)*y(k,16) &
                      + rxt(k,227)*y(k,40) + rxt(k,228)*y(k,41) + rxt(k,229)*y(k,42) &
                      + rxt(k,238)*y(k,21) + rxt(k,239)*y(k,21) + rxt(k,240)*y(k,21) &
                 + het_rates(k,66) )
         mat(k,252) = rxt(k,1)
         mat(k,241) = rxt(k,6)
         mat(k,600) = rxt(k,7)
         mat(k,10) = -( rxt(k,87) + rxt(k,95) + het_rates(k,67) )
         mat(k,591) = rxt(k,7)
         mat(k,12) = rxt(k,99) + rxt(k,98)*y(k,30)
         mat(k,13) = -( rxt(k,88) + rxt(k,99) + rxt(k,98)*y(k,30) + het_rates(k,68) )
         mat(k,149) = -( rxt(k,276) + het_rates(k,69) )
         mat(k,232) = rxt(k,78) + rxt(k,80)
         mat(k,139) = rxt(k,278)*y(k,30)
         mat(k,542) = -( rxt(k,214)*y(k,14) + rxt(k,216)*y(k,16) + rxt(k,217)*y(k,17) &
                      + rxt(k,219)*y(k,18) + rxt(k,221)*y(k,22) + rxt(k,222)*y(k,40) &
                      + rxt(k,223)*y(k,41) + rxt(k,224)*y(k,42) + rxt(k,236)*y(k,21) &
                 + het_rates(k,70) )
         mat(k,254) = rxt(k,3)
...
!----------------------------------------------
      integer :: k
      do k = 1,avec_len
         mat(k,138) = -( rxt(k,279) + rxt(k,278)*y(k,30) + het_rates(k,71) )
         mat(k,622) = rxt(k,71) + rxt(k,72)
         mat(k,231) = rxt(k,79) + rxt(k,81)
         mat(k,50) = rxt(k,263)
         mat(k,55) = rxt(k,264)
         mat(k,53) = -( rxt(k,264) + rxt(k,283) + het_rates(k,72) )
         ...
         mat(k,248) = -( rxt(k,1) + rxt(k,2) + rxt(k,3) + het_rates(k,74) )

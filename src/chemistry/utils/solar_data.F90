module solar_data
  ...
  character(len=shr_kind_cl) :: solar_proton_data_file= 'NONE'
...
!-----------------------------------------------------------------------
  subroutine solar_data_readnl( nlfile )
    ...
    use solar_proton_data,only: solar_proton_on
    ...
    call mpi_bcast(solar_proton_data_file,len(solar_proton_data_file),mpi_character, masterprocid, mpicom, ierr)
    ...
    if (masterproc) then
       ...
       write(iulog,*) 'solar_data_readnl: solar_proton_data_file = ',trim(solar_proton_data_file)
    ...
    solar_proton_on = trim(solar_proton_data_file)/='NONE'
...
!-----------------------------------------------------------------------
  subroutine solar_data_init()
    ...
    use solar_proton_data,only: solar_proton_init
    ...
    call solar_proton_init( solar_proton_data_file, fixed_solar, solar_data_ymd, solar_data_tod )

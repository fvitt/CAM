...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 104, & ! number of photolysis reactions
                            rxntot = 524, & ! number of total reactions
                            gascnt = 420, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 179, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 1891, & ! number of non-zero matrix entries
                            extcnt = 28, & ! number of species with external forcing
                            clscnt1 = 1, & ! number of species in explicit class
                            clscnt2 = 0, & ! number of species in hov class
                            clscnt3 = 0, & ! number of species in ebi class
                            clscnt4 = 178, & ! number of species in implicit class

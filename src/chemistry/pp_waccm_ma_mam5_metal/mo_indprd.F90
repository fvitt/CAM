...
!--------------------------------------------------------------------
         ...
         prod(:,112) = 0._r8
         prod(:,123) = 0._r8
         prod(:,150) = (rxt(:,64) +.800_r8*rxt(:,66) +.800_r8*rxt(:,68) +rxt(:,70)) &
                  + extfrc(:,26)
         prod(:,54) = 0._r8
         prod(:,65) = 0._r8
         prod(:,8) = 0._r8
         ...
         prod(:,24) = 0._r8
         prod(:,25) = 0._r8
         prod(:,158) = (rxt(:,63) +rxt(:,64) +rxt(:,65) +rxt(:,67) +rxt(:,69) + &
                 rxt(:,70)) + extfrc(:,28)
         prod(:,167) = 0._r8
         prod(:,126) = (rxt(:,65) +1.200_r8*rxt(:,66) +1.200_r8*rxt(:,68) +rxt(:,69)) &
                  + extfrc(:,24)
         prod(:,97) = (rxt(:,63) +rxt(:,67)) + extfrc(:,22)
         prod(:,159) = 0._r8
         prod(:,116) = (rxt(:,64) +rxt(:,65) +rxt(:,69) +rxt(:,70)) + extfrc(:,23)
         prod(:,173) = 0._r8
         prod(:,124) = 0._r8
         prod(:,63) = 0._r8
         prod(:,160) = + extfrc(:,21)

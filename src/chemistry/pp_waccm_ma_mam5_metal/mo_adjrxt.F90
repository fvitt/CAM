...
!--------------------------------------------------------------------
      ...
      rate(:,:, 109) = rate(:,:, 109) * inv(:,:, 2)
      rate(:,:, 113) = rate(:,:, 113) * inv(:,:, 2)
      rate(:,:, 117) = rate(:,:, 117) * inv(:,:, 2)
      ...
      rate(:,:, 316) = rate(:,:, 316) * inv(:,:, 2)
      rate(:,:, 320) = rate(:,:, 320) * inv(:,:, 2)
      rate(:,:, 325) = rate(:,:, 325) * inv(:,:, 2)
      rate(:,:, 326) = rate(:,:, 326) * inv(:,:, 2)
      rate(:,:, 334) = rate(:,:, 334) * inv(:,:, 1)
      rate(:,:, 336) = rate(:,:, 336) * inv(:,:, 1)
      rate(:,:, 342) = rate(:,:, 342) * inv(:,:, 1)
      rate(:,:, 347) = rate(:,:, 347) * inv(:,:, 2)
      ...
      rate(:,:, 491) = rate(:,:, 491) * inv(:,:, 1)
      rate(:,:, 497) = rate(:,:, 497) * inv(:,:, 1)
      rate(:,:, 498) = rate(:,:, 498) * inv(:,:, 1)
      rate(:,:, 499) = rate(:,:, 499) * inv(:,:, 1)
      rate(:,:, 500) = rate(:,:, 500) * inv(:,:, 1)
      rate(:,:, 501) = rate(:,:, 501) * inv(:,:, 1)
      rate(:,:, 502) = rate(:,:, 502) * inv(:,:, 1)
      rate(:,:, 503) = rate(:,:, 503) * inv(:,:, 1)
      rate(:,:, 505) = rate(:,:, 505) * inv(:,:, 2)
      rate(:,:, 507) = rate(:,:, 507) * inv(:,:, 2)
      rate(:,:, 513) = rate(:,:, 513) * inv(:,:, 2)
      rate(:,:, 341) = rate(:,:, 341) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 373) = rate(:,:, 373) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 399) = rate(:,:, 399) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 480) = rate(:,:, 480) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 496) = rate(:,:, 496) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 107) = rate(:,:, 107) * m(:,:)
      rate(:,:, 108) = rate(:,:, 108) * m(:,:)
      rate(:,:, 110) = rate(:,:, 110) * m(:,:)
      rate(:,:, 111) = rate(:,:, 111) * m(:,:)

...
!--------------------------------------------------------------
      ...
      cls_rxt_cnt(:,1) = (/     44,    63,     0,    31 /)
      cls_rxt_cnt(:,4) = (/     30,   280,   526,   232 /)

      solsym(:263) = (/ 'ALKNIT          ','ALKOOH          ','AOA_NH          ','bc_a1           ','bc_a4           ', &
                        ...
                        'XALKNIT         ','XBRONO2         ','XCLONO2         ','XHNO3           ','XHO2NO2         ', &
                        'XHONITR         ','XISOPNITA       ','XISOPNITB       ','XISOPNO3        ','XISOPNOOH       ', &
                        'XMPAN           ','XN              ','XNC4CH2OH       ','XNC4CHO         ','XNO             ', &
                        'XNO2            ','XNO2NO3         ','XNO2XNO3        ','XNO3            ','XNO3NO2         ', &
                        'XNOA            ','XNTERPO2        ','XNTERPOOH       ','XO              ','XO3             ', &
                        'XONITR          ','XOOH            ','XPAN            ','XPBZNIT         ','XTERPNIT        ', &
                        'XYLENES         ','XYLENOOH        ','XYLOL           ','XYLOLOOH        ','NHDEP           ', &
                        'NDEP            ','XNDEP           ','ACBZO2          ','ALKO2           ','BENZO2          ', &
                        ...
                        'TERPO2          ','TOLO2           ','XN2D            ','XO1D            ','XO2             ', &
                        'XYLENO2         ','XYLOLO2         ','H2O             ' /)

      adv_mass(:263) = (/   133.141340_r8,   104.142600_r8,    28.010400_r8,    12.011000_r8,    12.011000_r8, &
                            ...
                            250.445000_r8,   250.445000_r8,   250.445000_r8,   250.445000_r8,   250.445000_r8, &
                            250.445000_r8,   250.445000_r8,   250.445000_r8,   250.445000_r8,   250.445000_r8, &
                             28.010400_r8,   310.582400_r8,   140.134400_r8,   186.241400_r8,   215.240140_r8, &
                            186.241400_r8,   168.227200_r8,   154.201400_r8,   174.148000_r8,    92.136200_r8, &
                            133.141340_r8,   141.908940_r8,    97.457640_r8,    63.012340_r8,    79.011740_r8, &
                            135.114940_r8,   147.125940_r8,   147.125940_r8,   162.117940_r8,   163.125340_r8, &
                            147.084740_r8,    14.006740_r8,   147.125940_r8,   145.111140_r8,    30.006140_r8, &
                             46.005540_r8,   108.010480_r8,   108.010480_r8,    62.004940_r8,   108.010480_r8, &
                            119.074340_r8,   230.232140_r8,   231.239540_r8,    15.999400_r8,    47.998200_r8, &
                            ...
                            185.234000_r8,   173.140600_r8,    14.006740_r8,    15.999400_r8,   149.118600_r8, &
                            187.166400_r8,   203.165800_r8,    18.014200_r8 /)

      crb_mass(:263) = (/    60.055000_r8,    60.055000_r8,    12.011000_r8,    12.011000_r8,    12.011000_r8, &
                            ...
                            120.110000_r8,   120.110000_r8,   108.099000_r8,    84.077000_r8,    84.077000_r8, &
                             ...
                             48.044000_r8,     0.000000_r8,    60.055000_r8,    60.055000_r8,     0.000000_r8, &
                              0.000000_r8,     0.000000_r8,     0.000000_r8,     0.000000_r8,     0.000000_r8, &
                             36.033000_r8,   120.110000_r8,   120.110000_r8,     0.000000_r8,     0.000000_r8, &
                            ...
                            120.110000_r8,    84.077000_r8,     0.000000_r8,     0.000000_r8,    60.055000_r8, &
      ...
      clsmap(: 31,1) = (/    3,  21,  33,  34,  35,  36,  37,  38,  39,  40, &
                            ...
                            82,  83,  84, 113, 122, 123, 149, 171, 215, 216, &
                           217 /)

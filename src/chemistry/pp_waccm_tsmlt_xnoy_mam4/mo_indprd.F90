...
!--------------------------------------------------------------------
      if( class == 1 ) then
         ...
         prod(:,18) = (rxt(:,437)*y(:,62) +rxt(:,439)*y(:,87) +rxt(:,448)*y(:,62) + &
                 ...
                 .500_r8*rxt(:,553)*y(:,109) +1.800_r8*rxt(:,718)*y(:,178))*y(:,250) &
                  + (2.000_r8*rxt(:,471)*y(:,225) +.900_r8*rxt(:,472)*y(:,226) + &
                 rxt(:,474)*y(:,124) +2.000_r8*rxt(:,540)*y(:,238) + &
                 rxt(:,574)*y(:,234) +rxt(:,618)*y(:,260))*y(:,225) &
                  + (.200_r8*rxt(:,493)*y(:,29) +.100_r8*rxt(:,554)*y(:,111) + &
                 .270_r8*rxt(:,688)*y(:,6) +.270_r8*rxt(:,693)*y(:,110))*y(:,135) &
                  + (rxt(:,541)*y(:,226) +.450_r8*rxt(:,542)*y(:,232) + &
                 2.000_r8*rxt(:,543)*y(:,238))*y(:,238) &
                  + (.500_r8*rxt(:,704)*y(:,226) +.900_r8*rxt(:,706)*y(:,124)) &
                 *y(:,255) +rxt(:,53)*y(:,51) +.400_r8*rxt(:,76)*y(:,139) +rxt(:,81) &
                 *y(:,174) +.800_r8*rxt(:,85)*y(:,178)
         prod(:,19) = 0._r8
         prod(:,20) = 0._r8
         prod(:,21) = 0._r8
         prod(:,22) = 0._r8
         ...
         prod(:,27) = 0._r8
         prod(:,28) = 0._r8
         prod(:,29) =rxt(:,745)*y(:,250)*y(:,120) +rxt(:,755)*y(:,121)
         prod(:,30) = (rxt(:,646)*y(:,227) +rxt(:,651)*y(:,237) +rxt(:,656)*y(:,239) + &
                 rxt(:,663)*y(:,141))*y(:,125) +.500_r8*rxt(:,553)*y(:,250)*y(:,109) &
                  +.200_r8*rxt(:,699)*y(:,245)*y(:,124) +.500_r8*rxt(:,715)*y(:,177) &
                 *y(:,126)
         prod(:,31) = (rxt(:,648)*y(:,227) +rxt(:,653)*y(:,237) +rxt(:,658)*y(:,239) + &
                 rxt(:,666)*y(:,141))*y(:,196) +.200_r8*rxt(:,721)*y(:,202)*y(:,124) &
                  +.500_r8*rxt(:,717)*y(:,199)*y(:,177) +.500_r8*rxt(:,562)*y(:,250) &
                 *y(:,191)
!--------------------------------------------------------------------

...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 179, & ! number of photolysis reactions
                            rxntot = 841, & ! number of total reactions
                            gascnt = 662, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 264, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 2615, & ! number of non-zero matrix entries
                            extcnt = 24, & ! number of species with external forcing
                            clscnt1 = 32, & ! number of species in explicit class
                            clscnt2 = 0, & ! number of species in hov class
                            clscnt3 = 0, & ! number of species in ebi class
                            clscnt4 = 232, & ! number of species in implicit class

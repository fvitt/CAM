...
!--------------------------------------------------------------------
      ...
      rate(:,:,184) = rate(:,:,184) * inv(:,:, 2)
      rate(:,:,189) = rate(:,:,189) * inv(:,:, 2)
      rate(:,:,193) = rate(:,:,193) * inv(:,:, 2)
      rate(:,:,199) = rate(:,:,199) * inv(:,:, 1)
      rate(:,:,200) = rate(:,:,200) * inv(:,:, 1)
      rate(:,:,201) = rate(:,:,201) * inv(:,:, 1)
      rate(:,:,202) = rate(:,:,202) * inv(:,:, 1)
      rate(:,:,205) = rate(:,:,205) * inv(:,:, 2)
      ...
      rate(:,:,489) = rate(:,:,489) * inv(:,:, 1)
      rate(:,:,490) = rate(:,:,490) * inv(:,:, 1)
      rate(:,:,516) = rate(:,:,516) * inv(:,:, 1)
      rate(:,:,553) = rate(:,:,553) * inv(:,:, 1)
      rate(:,:,557) = rate(:,:,557) * inv(:,:, 1)
      rate(:,:,558) = rate(:,:,558) * inv(:,:, 1)
      rate(:,:,559) = rate(:,:,559) * inv(:,:, 1)
      rate(:,:,560) = rate(:,:,560) * inv(:,:, 1)
      rate(:,:,562) = rate(:,:,562) * inv(:,:, 1)
      rate(:,:,646) = rate(:,:,646) * inv(:,:, 1)
      rate(:,:,648) = rate(:,:,648) * inv(:,:, 1)
      rate(:,:,651) = rate(:,:,651) * inv(:,:, 1)
      rate(:,:,653) = rate(:,:,653) * inv(:,:, 1)
      rate(:,:,656) = rate(:,:,656) * inv(:,:, 1)
      rate(:,:,658) = rate(:,:,658) * inv(:,:, 1)
      rate(:,:,668) = rate(:,:,668) * inv(:,:, 1)
      rate(:,:,669) = rate(:,:,669) * inv(:,:, 1)
      rate(:,:,675) = rate(:,:,675) * inv(:,:, 1)
      rate(:,:,676) = rate(:,:,676) * inv(:,:, 1)
      rate(:,:,833) = rate(:,:,833) * inv(:,:, 2)
      rate(:,:,836) = rate(:,:,836) * inv(:,:, 2)
      rate(:,:,182) = rate(:,:,182) * m(:,:)
      rate(:,:,183) = rate(:,:,183) * m(:,:)
      rate(:,:,185) = rate(:,:,185) * m(:,:)
      rate(:,:,186) = rate(:,:,186) * m(:,:)

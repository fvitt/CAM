...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: phtcnt = 100, & ! number of photolysis reactions
                            rxntot = 499, & ! number of total reactions
                            gascnt = 399, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 150, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 1504, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 126, & ! number of species in implicit class

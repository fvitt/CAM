...
!--------------------------------------------------------------------
      ...
      rate(:,:,101) = rate(:,:,101) * inv(:,:, 1)
      rate(:,:,103) = rate(:,:,103) * inv(:,:, 1)
      rate(:,:,106) = rate(:,:,106) * inv(:,:, 2)
      rate(:,:,112) = rate(:,:,112) * inv(:,:, 2)
      rate(:,:,114) = rate(:,:,114) * inv(:,:, 2)
      ...
      rate(:,:,287) = rate(:,:,287) * inv(:,:, 2)
      rate(:,:,291) = rate(:,:,291) * inv(:,:, 2)
      rate(:,:,292) = rate(:,:,292) * inv(:,:, 2)
      rate(:,:,298) = rate(:,:,298) * inv(:,:, 2)
      rate(:,:,309) = rate(:,:,309) * inv(:,:, 1)
      rate(:,:,311) = rate(:,:,311) * inv(:,:, 1)
      rate(:,:,317) = rate(:,:,317) * inv(:,:, 1)
      rate(:,:,322) = rate(:,:,322) * inv(:,:, 2)
      ...
      rate(:,:,473) = rate(:,:,473) * inv(:,:, 1)
      rate(:,:,474) = rate(:,:,474) * inv(:,:, 1)
      rate(:,:,475) = rate(:,:,475) * inv(:,:, 1)
      rate(:,:,476) = rate(:,:,476) * inv(:,:, 1)
      rate(:,:,477) = rate(:,:,477) * inv(:,:, 1)
      rate(:,:,478) = rate(:,:,478) * inv(:,:, 1)
      rate(:,:,480) = rate(:,:,480) * inv(:,:, 2)
      rate(:,:,482) = rate(:,:,482) * inv(:,:, 2)
      rate(:,:,488) = rate(:,:,488) * inv(:,:, 2)
      rate(:,:,316) = rate(:,:,316) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:,348) = rate(:,:,348) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:,374) = rate(:,:,374) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:,455) = rate(:,:,455) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:,471) = rate(:,:,471) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:,101) = rate(:,:,101) * m(:,:)
      rate(:,:,102) = rate(:,:,102) * m(:,:)
      rate(:,:,103) = rate(:,:,103) * m(:,:)
      rate(:,:,104) = rate(:,:,104) * m(:,:)

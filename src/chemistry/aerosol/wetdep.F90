...
subroutine wetdep_init()
  ...
  call addfld('WD_CLD',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_QME',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_PRAIN',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_BERGSO',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_NEVAPR',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_ICWMRDP',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_RPRDDP',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_ICWMRSH',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_RPRDSH',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_SH_FRAC',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_DP_FRAC',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_NEVAPR_SHCU',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_NEVAPR_DPCU',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_CLDICE',  (/ 'lev' /), 'A', ' ', ' ')
  call addfld('WD_CLDLIQ',  (/ 'lev' /), 'A', ' ', ' ')

  call add_default('WD_CLD', 9, ' ')
  call add_default('WD_QME', 9, ' ')
  call add_default('WD_PRAIN', 9, ' ')
  call add_default('WD_BERGSO', 9, ' ')
  call add_default('WD_NEVAPR', 9, ' ')
  call add_default('WD_ICWMRDP', 9, ' ')
  call add_default('WD_RPRDDP', 9, ' ')
  call add_default('WD_ICWMRSH', 9, ' ')
  call add_default('WD_RPRDSH', 9, ' ')
  call add_default('WD_SH_FRAC', 9, ' ')
  call add_default('WD_DP_FRAC', 9, ' ')
  call add_default('WD_NEVAPR_SHCU', 9, ' ')
  call add_default('WD_NEVAPR_DPCU', 9, ' ')
  call add_default('WD_CLDICE', 9, ' ')
  call add_default('WD_CLDLIQ', 9, ' ')
...
subroutine wetdep_inputs_set( state, pbuf, inputs )
  ...
  call outfld('WD_CLD', inputs%cldt(:ncol,:), ncol, lchnk)
  call outfld('WD_QME', inputs%qme(:ncol,:), ncol, lchnk)
  call outfld('WD_PRAIN', inputs%prain(:ncol,:), ncol, lchnk)

  call outfld('WD_NEVAPR', inputs%evapr(:ncol,:), ncol, lchnk)
  call outfld('WD_ICWMRDP', icwmrdp(:ncol,:), ncol, lchnk)
  call outfld('WD_ICWMRSH', icwmrsh(:ncol,:), ncol, lchnk)
  call outfld('WD_RPRDDP', rprddp(:ncol,:), ncol, lchnk)
  call outfld('WD_RPRDSH', rprdsh(:ncol,:), ncol, lchnk)
  call outfld('WD_SH_FRAC', sh_frac(:ncol,:), ncol, lchnk)
  call outfld('WD_DP_FRAC', dp_frac(:ncol,:), ncol, lchnk)
  call outfld('WD_NEVAPR_SHCU', evapcsh(:ncol,:), ncol, lchnk)
  call outfld('WD_NEVAPR_DPCU', evapcdp(:ncol,:), ncol, lchnk)
  call outfld('WD_CLDICE', state%q(:ncol,:,ixcldice), ncol, lchnk)
  call outfld('WD_CLDLIQ', state%q(:ncol,:,ixcldliq), ncol, lchnk)
  ...
  call outfld('WD_BERGSO', inputs%bergso(:ncol,:), ncol, lchnk)

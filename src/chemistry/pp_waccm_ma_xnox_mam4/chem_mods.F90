...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: phtcnt = 108, & ! number of photolysis reactions
                            rxntot = 444, & ! number of total reactions
                            gascnt = 336, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 112, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 914, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 90, & ! number of species in implicit class

module edyn3D_current_sources_mod
...
contains
  ...
  subroutine edyn3D_calculate_S(fline_p,fline_s1,fline_s2,fline_r)
    ...
    use edyn3D_params,    only:nmlat_h,nmlatS2_h,J3LB,val_fill,nhgt_fix,use_stabil
...
end module edyn3D_current_sources_mod

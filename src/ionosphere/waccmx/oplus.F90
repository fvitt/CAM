...
!-----------------------------------------------------------------------
  subroutine oplus_init( adiff_limiter_in, shapiro_const_in, enforce_floor_in, ring_polar_filter_in, ionos_debug_hist )
    ...
    if (debug_hist) then
       ...
       call addfld ('OPLUS_UI'   ,(/ 'lev' /), 'I', 'cm/s' ,'OPLUS_UI'    , gridname='geo_grid')
       call addfld ('OPLUS_VI'   ,(/ 'lev' /), 'I', 'cm/s' ,'OPLUS_VI'    , gridname='geo_grid')
       call addfld ('OPLUS_WI'   ,(/ 'lev' /), 'I', 'cm/s' ,'OPLUS_WI'    , gridname='geo_grid')

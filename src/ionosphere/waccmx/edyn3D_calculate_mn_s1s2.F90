!
     subroutine edyn3D_calculate_mn_s1s2(fline_p,fline_s1,fline_s2,fline_r)

       use edyn3D_fieldline, only: fieldline_s1,fieldline_s2,fieldline_r,fieldline_p
!       use edyn3D_fieldline, only: fieldline_s1,fline_s1,fieldline_s2,fline_s2,&
!                                   fieldline_r,fline_r,fieldline_p,fline_p
       use edyn3D_params,    only: m1f,m2f,m3f,nmlat_h,nmlatS2_h,nhgt_fix,hgt_fix,&
                               hgt_fix_r,nhgt_fix_r,r0,ylonm,ylonm_s,rho,rho_s,pi,ylatm
       ...
       type(fieldline_r),dimension(mlon0_p-1:mlon1_p+1,nmlat_h,2),intent(inout)   :: fline_r
       !
       ! Local variables
       !
...
!
     ...
     end subroutine edyn3D_calculate_mn_s1s2
